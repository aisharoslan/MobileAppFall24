...
// data lives in parent component
const items = [
    {
      id: '123',
...
export default function AccordionPage() {
    // content should live here - where we use it, we want Accordion itself to be a REUSABLE COMPONENT
    // gonna need a prop to take this data, need label and content at least
